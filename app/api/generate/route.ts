...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'w-gala':                '[TRIGGER], full three-quarter body shot photographed from a distance, showing the woman from head down to the knees with the elegant floor-length gown clearly visible, wearing an elegant floor-length formal gala evening gown in a rich tone like black, emerald, sapphire, deep red or champagne, in satin or velvet with an elegant sophisticated gala neckline such as a tasteful V-neck, draped cowl or halter, simple tasteful jewelry, holding a small elegant clutch or minaudière gracefully in front of her with a poised elegant posture, at a glamorous black-tie gala in an elegant ballroom, warm ambient lighting and soft glowing bokeh from chandeliers, refined opulent décor softly blurred behind, cinematic shallow depth of field, sophisticated formal elegance',
