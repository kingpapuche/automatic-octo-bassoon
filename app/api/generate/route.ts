...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'w-leaning-elegant':    '[TRIGGER], portrait of woman leaning sideways with one shoulder against a clean modern building exterior wall outdoors, body relaxed and tilted at an angle resting her weight on the wall, one hand in pocket, a relaxed casual top such as a fine-gauge knit top or a soft casual blouse with a flattering modest neckline like a crew or notched neck, minimalist and intentional, no blazer, soft natural daylight, approachable relaxed confidence',
