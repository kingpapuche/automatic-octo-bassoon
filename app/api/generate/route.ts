...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'w-cocktail-glamour':    '[TRIGGER], medium-wide shot of woman showing head to waist, an elegant classy cocktail dress in a flattering color such as classic black, emerald green, deep wine red or navy, with a flattering yet tasteful neckline, sophisticated and refined, sitting at an upscale cocktail bar, on the bar in the foreground an elegant cocktail glass clearly visible, bottles and bar softly blurred behind, ambient evening mood lighting, shallow depth of field',
