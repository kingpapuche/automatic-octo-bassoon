...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'bold-colored-blazer': '[TRIGGER], cowboy shot, three-quarter length portrait, waist-up framing, bold colored blazer (deep red or emerald green), white t-shirt underneath, the full blazer clearly visible, bright creative studio with a bold colored backdrop, natural light, confident statement',
  'motorcycle-street':   '[TRIGGER], cowboy shot, three-quarter length portrait, waist-up framing, brown leather jacket over a white t-shirt, the full jacket clearly visible, leaning against a classic motorcycle on an urban street, natural daylight, cool confident relaxed vibe',
  'classic-car':         '[TRIGGER], cowboy shot, three-quarter length portrait, waist-up framing, smart casual jacket, the full jacket clearly visible, leaning against a sleek classic premium car on a city street, natural daylight, confident stylish vibe',
