...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'w-night-city-glamour':  '[TRIGGER], medium-wide shot of woman showing head to waist, a glamorous evening top with a luminous satin or subtle metallic sheen in a rich tone like emerald, champagne, metallic silver or black, with an elegant modest neckline like a cowl or boat neck that covers the décolletage, statement gold earrings, glamorous and polished, on a glamorous upscale city nightlife street at night, warm glowing bokeh from neon signs and illuminated storefronts, softly blurred city lights forming glowing circles behind, cinematic shallow depth of field, urban nighttime glamour',
