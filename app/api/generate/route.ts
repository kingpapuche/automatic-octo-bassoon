...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'w-red-power-suit':      '[TRIGGER], three-quarter length shot of woman showing head to thighs, wearing a matching bold red power suit, the entire softly tailored relaxed-fit red blazer visible from shoulders to waist with matching red trousers, white t-shirt underneath, modern creative office background, natural light, confident power pose, statement professional',
  'w-emerald-blazer':      '[TRIGGER], three-quarter length shot of woman showing head to thighs, the entire blazer visible, a softly tailored relaxed-fit emerald green blazer with a modern longer cut, black top underneath, bright creative studio with a colored backdrop, soft side natural light, bold creative professional',
  'w-mustard-creative':    '[TRIGGER], medium-wide shot of woman showing head to waist, an elegant deep burgundy merlot silk blouse, bright creative studio with a warm rich colored backdrop, natural lighting, bold expressive creative professional',
  'w-statement-coral':     '[TRIGGER], three-quarter length shot of woman showing head to thighs, the entire blazer visible, a softly tailored relaxed-fit cobalt blue blazer with a modern cut, white top underneath, modern creative office background, vibrant natural lighting, bold confident creative professional',
