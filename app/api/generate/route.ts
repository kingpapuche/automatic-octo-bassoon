...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'w-gala':                '[TRIGGER], full three-quarter body shot photographed from a distance at a slightly low camera angle, showing the woman from head down to the knees with the elegant floor-length gown clearly visible, wearing a striking statement floor-length gala gown in a bold radiant standout colour such as vibrant ruby red, shimmering metallic gold or champagne, or a rich luminous emerald or sapphire, in light-catching satin with a subtle elegant sheen that stands out beautifully against the crowd, in a flattering A-line or elegant fitted silhouette, with an elegant sophisticated gala neckline such as a tasteful V-neck, draped cowl or halter, simple tasteful jewelry, posing in an elegant red-carpet stance with her body turned slightly to a three-quarter angle, weight on the back leg with one foot forward, torso gently angled and chin slightly raised, holding a small elegant clutch to one side, graceful and poised, at a glamorous black-tie gala in an elegant ballroom, warm ambient lighting and soft glowing bokeh from chandeliers, refined opulent décor and the background gala crowd thrown far out of focus into soft creamy bokeh, shot on an 85mm portrait lens at a wide aperture with very shallow depth of field, the subject tack-sharp and standing out from the softly blurred background, sophisticated formal elegance',
...
export async function POST(request: NextRequest) {
  try {
    ...
    for (const styleId of styleIds) {
      ...
      // Gala: elegante clutch-pose, weer slappe hangende armen.
      if (styleId === 'w-gala') {
        styleNegative += ', arms hanging limply straight down at the sides, stiff awkward pose, large handbag, oversized bag, tote bag'
      }
