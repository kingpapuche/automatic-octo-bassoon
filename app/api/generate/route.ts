...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'wine-bar-relaxed':    '[TRIGGER], medium-wide shot showing head to waist, dark sweater or shirt, sitting at a cozy wine bar, on the table in the foreground a single glass of red wine clearly visible, rows of wine bottles on wooden shelves softly blurred behind, warm intimate lighting, shallow depth of field',
  'coffee-shop-date':    '[TRIGGER], medium-wide shot showing head to waist, casual smart sweater or shirt, sitting at a table in a modern coffee shop, on the table in the foreground a cup of coffee clearly visible, cozy cafe with an espresso machine softly blurred behind, warm casual daytime lighting, shallow depth of field',
  'rooftop-bar-evening': '[TRIGGER], medium-wide shot showing head to waist, stylish jacket or dark shirt, at a table on a rooftop bar terrace in the evening, on the table in the foreground a cocktail glass clearly visible, city skyline and string lights softly blurred behind, dusk sky, warm evening ambiance, shallow depth of field',
  ...
  'w-restaurant-elegant':  '[TRIGGER], medium-wide shot of woman showing head to waist, smart casual silk blouse, sitting at a dining table in an elegant restaurant, on the table in the foreground a plate of beautifully plated gourmet food and a single glass of red wine clearly visible, warm candlelit fine-dining ambiance, softly blurred restaurant background with shallow depth of field',
  'w-wine-bar-casual':     '[TRIGGER], medium-wide shot of woman showing head to waist, stylish casual top, sitting at a cozy wine bar, on the table in the foreground a single glass of red wine clearly visible, rows of wine bottles on wooden shelves softly blurred behind, warm intimate lighting, shallow depth of field',
  ...
  'w-cafe-date':           '[TRIGGER], medium-wide shot of woman showing head to waist, casual sweater, sitting at a table in a charming cafe, on the table in the foreground a cup of coffee and a small pastry clearly visible, cozy cafe softly blurred behind, warm casual lighting, relaxed approachable, shallow depth of field',
  'w-rooftop-bar':         '[TRIGGER], medium-wide shot of woman showing head to waist, stylish evening top, at a table on a rooftop bar terrace in the evening, on the table in the foreground a cocktail glass clearly visible, city skyline and string lights softly blurred behind, dusk sky, warm evening ambiance, shallow depth of field',
