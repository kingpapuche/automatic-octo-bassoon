...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'w-sitting-confident':  '[TRIGGER], portrait of professional woman seated at a wooden desk, leaning slightly forward with both hands fully visible and clasped together on the desk in front of her, a tailored navy or charcoal blazer worn over a top with a modest neckline, modern office with large floor-to-ceiling windows and a city view, soft natural light, warm confident engaging presence',
  'w-leaning-elegant':    '[TRIGGER], portrait of woman clearly leaning sideways with her shoulder and upper back resting against a clean modern building exterior wall outdoors, visibly resting her weight on the wall in a relaxed leaning pose, not standing upright away from the wall, body tilted at an angle, one hand in pocket, a relaxed casual top such as a fine-gauge knit top or a soft casual blouse with a flattering modest neckline like a crew or notched neck, minimalist and intentional, no blazer, soft natural daylight, approachable relaxed confidence',
