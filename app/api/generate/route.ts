...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'w-wine-bar-casual':     '[TRIGGER], medium-wide shot of woman showing head to waist, stylish casual top, sitting at a cozy wine bar, a single large glass of red wine prominently in the foreground on the table, fully visible and not cropped, rows of wine bottles on wooden shelves softly blurred behind, warm intimate lighting, shallow depth of field',
