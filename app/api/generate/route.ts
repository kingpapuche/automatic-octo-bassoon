...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'leaning-elegant':     '[TRIGGER], casually leaning with his shoulder against a wall, relaxed leaning pose, one hand in pocket, smart casual blazer over a shirt, clean uncluttered upscale interior softly blurred in the background, shallow depth of field with strong focus on the subject, soft natural light, approachable elegant confidence',
  ...
  'w-leaning-elegant':    '[TRIGGER], portrait of woman casually leaning with her shoulder against a wall, relaxed leaning pose, one hand in pocket, smart casual blazer, clean uncluttered upscale interior softly blurred in the background, shallow depth of field with strong focus on the subject, soft natural light, approachable elegant confidence',
