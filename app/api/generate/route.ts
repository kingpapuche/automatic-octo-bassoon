...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'w-night-city-glamour':  '[TRIGGER], medium-wide shot of woman showing head to waist, a glamorous evening top with a luminous satin or subtle metallic sheen in a rich tone like emerald, champagne, metallic silver or black, with an elegant modest neckline like a cowl or boat neck that covers the décolletage, statement gold earrings, glamorous and polished, on a city street at night, bright city lights and neon signs bokeh behind, urban nighttime glamour',
