...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'w-pussybow-elegant':    '[TRIGGER], three-quarter length shot of woman showing head to thighs, the tweed jacket and blouse visible, cream silk blouse with pussy bow detail, tweed jacket, clean seamless light neutral studio backdrop, soft natural light, classic elegant style',
  ...
  'w-cardigan-soft':       '[TRIGGER], medium-wide shot of woman showing head to waist, soft beige cardigan over a blouse, bright modern professional office softly blurred, clean and uncluttered, soft natural light, approachable smart casual professional',
  'w-knit-twinset':        '[TRIGGER], medium-wide shot of woman showing head to waist, matching knit top and cardigan in neutral tones, clean soft neutral background, warm natural light, refined smart casual',
