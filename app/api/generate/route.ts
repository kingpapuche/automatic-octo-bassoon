...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'w-power-blazer-navy':   '[TRIGGER], professional woman portrait, navy blue tailored blazer, white silk blouse, standing by large floor-to-ceiling windows with a clear city skyline visible behind, modern high-rise office, arms crossed confidently, soft natural light, executive look',
