...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'thoughtful-pose':     '[TRIGGER], in a natural thoughtful and contemplative pose, resting the chin on a hand or a finger to the cheek or temple, gazing thoughtfully to the side or slightly upward, professional attire, soft neutral background, soft natural light, intellectual reflective look',
  ...
  'w-thoughtful-pose':    '[TRIGGER], portrait of woman in a natural thoughtful and contemplative pose, resting the chin on a hand or a finger to the cheek or temple, gazing thoughtfully to the side or slightly upward, professional attire, soft neutral background, soft natural light, intelligent elegant reflective look',
