...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'w-autumn-forest':       '[TRIGGER], portrait of woman, a cozy knit sweater in a warm autumn tone such as caramel, rust, cream or warm brown, in an autumn forest with golden and orange foliage, soft warm natural daylight, relaxed nature vibe',
