...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'w-coffee-shop-warm':    '[TRIGGER], medium-wide shot of woman showing head to waist, a modern casual outfit such as a relaxed fine-knit sweater or a soft casual blouse in a fresh flattering tone, in a bright airy modern coffee shop next to a large window, holding a cappuccino or a takeaway coffee cup, plants and a minimal cafe counter softly blurred behind, bright natural daytime light, relaxed approachable and contemporary',
