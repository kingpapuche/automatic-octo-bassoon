...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'w-startup-casual':      '[TRIGGER], medium-wide shot of woman showing head to waist, light blue button-down shirt, no blazer, alone by herself with no one else present, bright modern office softly blurred, quiet and uncluttered, natural light, energetic approachable professional',
