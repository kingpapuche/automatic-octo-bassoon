...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'w-holding-tablet':     '[TRIGGER], full three-quarter body shot photographed from a distance, showing the woman from head down to the thighs with the whole outfit visible, standing turned slightly to the side at a relaxed three-quarter angle to the camera, holding a tablet device in front of her, the tablet clearly visible in frame, business casual attire, alone by herself with no one else present in a quiet empty modern office, soft natural light, tech-savvy professional',
}
