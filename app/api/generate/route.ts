...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'motorcycle-street':   '[TRIGGER], three-quarter length shot showing head to thighs, leaning casually against a classic parked motorcycle on an urban street, the full motorcycle prominently visible beside him in the frame, brown leather jacket over a white t-shirt, the full jacket visible, natural daylight, cool confident relaxed vibe',
