...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'motorcycle-street':   '[TRIGGER], full shot from head to knees at a flattering 45-degree angle, sitting on a classic motorcycle on an urban street, most of the full motorcycle clearly and prominently visible in the frame, brown leather jacket over a white t-shirt, one hand on the handlebar, natural daylight, cool confident relaxed vibe',
  'classic-car':         '[TRIGGER], three-quarter length shot showing head to thighs, leaning casually against a sleek classic premium car on a city street, the classic car prominently visible beside him in the frame, smart casual jacket, the full jacket visible, natural daylight, confident stylish vibe',
