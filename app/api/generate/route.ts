...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'golden-hour':         '[TRIGGER], portrait, casual smart shirt, warm neutral studio background, warm soft studio lighting, lifestyle professional',
  'park-natural':        '[TRIGGER], medium shot, casual smart outfit or plain t-shirt, clean light studio background, soft studio lighting, fresh relaxed',
  'rooftop-city':        '[TRIGGER], medium shot, smart casual outfit, neutral gray studio background, soft studio lighting, modern professional',
  'city-walk':           '[TRIGGER], medium shot, casual jacket, neutral studio background, soft studio lighting, urban smart casual',
  ...
  'w-white-tee-natural':   '[TRIGGER], half body portrait of woman, clean white t-shirt, clean light studio background, soft studio lighting, fresh, genuine smile',
  ...
  'w-park-outdoor':        '[TRIGGER], half body portrait of woman, light casual blouse, clean light studio background, soft studio lighting, fresh relaxed',
  'w-rooftop-golden':      '[TRIGGER], medium shot of woman, smart casual blouse, warm neutral studio background, warm soft studio lighting, lifestyle professional',
  ...
  'w-city-walk':           '[TRIGGER], medium shot of woman, casual jacket and smart top, neutral studio background, soft studio lighting, dynamic smart casual',
  'w-beach-professional':  '[TRIGGER], half body portrait of woman, white linen blouse, warm light studio background, soft warm studio lighting, relaxed professional',
