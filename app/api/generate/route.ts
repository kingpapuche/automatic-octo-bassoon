...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'w-autumn-forest':       '[TRIGGER], portrait of woman, a chunky cable-knit sweater or a cozy oversized turtleneck knit with thick warm texture in a warm autumn tone such as caramel, rust, cream or warm brown, in an autumn forest with golden and orange foliage, soft warm natural daylight, relaxed nature vibe',
  'w-mountain-lake':       '[TRIGGER], portrait of woman, a stylish casual outdoor jacket such as a quilted jacket or field jacket in a solid earthy tone like olive, navy or camel, standing by a serene mountain lake with scenic peaks in the background, soft natural daylight, adventurous relaxed vibe',
