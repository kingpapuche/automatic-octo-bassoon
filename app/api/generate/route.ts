...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'w-leather-jacket-edge': '[TRIGGER], full three-quarter body shot photographed from a distance, showing the woman from head down to the thighs with the whole leather jacket fully visible, a fitted black leather moto biker jacket with a structured silhouette, dark top underneath, city street background, natural evening light, edgy sophisticated',
