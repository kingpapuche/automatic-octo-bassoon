...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'rooftop-bar-evening': '[TRIGGER], medium-wide shot showing head to waist, stylish jacket or dark shirt, sitting at a table on a rooftop bar terrace in the evening, holding a cocktail in a rocks glass (an old fashioned) clearly visible, city skyline and string lights softly blurred behind, dusk sky, warm evening ambiance, shallow depth of field',
