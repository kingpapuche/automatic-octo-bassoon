...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'w-evening-rooftop':     '[TRIGGER], half body portrait of woman, an elegant satin evening top in classic black, navy or champagne with a flattering yet tasteful neckline, sophisticated and glamorous, statement gold earrings, rooftop background with city lights, warm evening lighting, glamorous nighttime',
  ...
  'holding-tablet':      '[TRIGGER], three-quarter length shot from head to thighs, standing turned slightly to the side at a relaxed three-quarter angle to the camera, holding a tablet device in front of him, the tablet clearly and fully visible in frame, business casual attire, modern office, soft natural light, tech-savvy professional',
  ...
  'w-holding-tablet':     '[TRIGGER], full three-quarter body shot photographed from a distance, showing the woman from head down to the thighs with the whole outfit visible, standing turned slightly to the side at a relaxed three-quarter angle to the camera, holding a tablet device in front of her, the tablet clearly visible in frame, a tailored business blazer worn over a top, alone by herself in a private empty modern office, completely empty with no other people anywhere in the background, soft natural light, tech-savvy professional',
}
