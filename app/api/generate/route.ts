...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  'w-restaurant-evening':  '[TRIGGER], medium-wide shot of woman showing head to waist, an elegant refined evening blouse with a modest higher neckline that fully covers the décolletage, alone by herself with no one else present, seated at a private candlelit corner table in an intimate restaurant, on the table in the foreground a plate of beautifully plated food and a single glass of red wine clearly visible, warm romantic ambiance, the rest of the restaurant behind her very dark and thrown far out of focus into deep shadow, extremely shallow depth of field',
