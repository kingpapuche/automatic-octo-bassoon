...
export default function UploadPage() {
  ...
  // ── DIRECT SUPABASE UPLOAD (bypasses Vercel limits!) ──────────
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Upload elke foto rechtstreeks naar Supabase vanuit de browser
      ...
      // Start training via API (enkel URLs worden doorgestuurd — geen foto data)
